...
int main() {
    ...
    bool ret0 = myCircularQueue.enQueue(1); // return True
    bool ret1 = myCircularQueue.enQueue(2); // return True
    bool ret2 = myCircularQueue.enQueue(3); // return True
    bool ret3 = myCircularQueue.enQueue(4); // return False
    int rear0 = myCircularQueue.Rear();     // return 3
    bool ret4 = myCircularQueue.isFull();   // return True
    bool ret5 = myCircularQueue.deQueue();  // return True
    bool ret6 = myCircularQueue.enQueue(4); // return True
    int rear1 = myCircularQueue.Rear();     // return 4
}
