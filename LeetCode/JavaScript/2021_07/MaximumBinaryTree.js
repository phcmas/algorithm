...
var constructTree = function(start, end, nums) {
    var treeNode = {};
    var maximum = 0;
    var index = 0;
    ...
    index = nums.indexOf(maximum);
    treeNode.val = maximum;
...
var nums0 = [3,2,1,6,0,5];
var nums1 = [3,2,1];

var ans0 = constructMaximumBinaryTree(nums0);
var ans1 = constructMaximumBinaryTree(nums1);
