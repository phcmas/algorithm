 ...
 *  they are put in his new invented basket. Rick has n empty baskets, the ith basket is at position[i], 
...
public class MagneticForceBetweenTwoBalls {
    ...
    private boolean distanceMoreThan(int[] position, int dist, int m) {
        int lastIndex = 0;
        int count = 1;
